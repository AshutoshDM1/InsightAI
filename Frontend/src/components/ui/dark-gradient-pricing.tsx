    ...
    >
      <Card
        className={cn(
          ...
          "dark:border-zinc-700 dark:bg-gradient-to-br dark:from-zinc-950 dark:to-zinc-900",
          "border-zinc-200 bg-gradient-to-br from-zinc-50/50 to-zinc-100/80",
          "p-6",
          className
        )}
      >
        <div className="flex flex-col items-center justify-center border-b pb-6 dark:border-zinc-700 border-zinc-200">
